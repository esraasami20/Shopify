...
namespace Shopify.Services
{
    public class CartService
    {
        ...
        public Cart GetAvaliableCart(IIdentity Customer)
        {
            ...
            Cart cart= _db.Carts.Include(i => i.CartItems).SingleOrDefault(c => c.CustomerID == CustomerID && c.Approved == false && c.Isdeleted == false);
            return cart;
        }
        ...
        {
            Cart Cart2 = _db.Carts.SingleOrDefault(c => c.CartId ==cart.CartId && c.Approved == false && c.Isdeleted == false);
            if(Cart2 != null)
            {
